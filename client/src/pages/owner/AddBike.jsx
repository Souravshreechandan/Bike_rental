    ...
    return (
        <div className="px-4 pt-10 md:px-10 w-full">
            <div className="max-w-3xl mx-auto flex flex-col gap-5">
                <Title
                    title='Add New Bike'
                    subTitle='Fill in details to list a new bike for booking including pricing, availability, and bike specification.'
                />

                <form onSubmit={onSubmitHandeler} className='flex flex-col gap-5 text-gray-500 text-sm mt-6'>
                    ...
                    <div className='grid grid-cols-1 md:grid-cols-2 gap-6'>
                        <div className='flex flex-col w-full'>
                            <label>Brand</label>
                            <input type="text" placeholder='e.g. BMW, Kawasaki...' required
                                className='px-3 py-2 mt-1 border border-borderColor rounded-md outline-none'
                                value={bike.brand} onChange={e => setBike({ ...bike, brand: e.target.value })} />
                        </div>
                        ...
                        <div className='flex flex-col w-full'>
                            ...
                            <input type="text" placeholder='e.g. Top, High...' required
                                className='px-3 py-2 mt-1 border border-borderColor rounded-md outline-none'
                                value={bike.model} onChange={e => setBike({ ...bike, model: e.target.value })} />
                        </div>
                    </div>
                    ...
                    <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6'>
                        <div className='flex flex-col w-full'>
                            ...
                            <input type="number" placeholder='2025' required
                                className='px-3 py-2 mt-1 border border-borderColor rounded-md outline-none'
                                value={bike.year} onChange={e => setBike({ ...bike, year: e.target.value })} />
                        </div>
                    ...
                    <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6'>
                        ...
                        <div className='flex flex-col w-full'>
                            ...
                            <input type="number" placeholder='2' required
                                className='px-3 py-2 mt-1 border border-borderColor rounded-md outline-none'
                                value={bike.seating_capacity} onChange={e => setBike({ ...bike, seating_capacity: e.target.value })} />
                        </div>
                    </div>
                    ...
                    <div className='flex flex-col w-full'>
                        ...
                        <textarea rows={5} placeholder='...' required
                            className='px-3 py-2 mt-1 border border-borderColor rounded-md outline-none'
                    ...
                    <button
                        type="submit"
                        className='flex items-center gap-2 px-4 py-2.5 mt-4 bg-primary text-white rounded-md font-medium w-max cursor-pointer hover:bg-blue-700 transition-colors'
                    >
