  ...
  return (
    ...
    max-w-13 md:max-w-60 w-full border-r border-borderColor text-sm'>
        <div className='group relative'>
            <label htmlFor="image">
                <img src={image ? URL.createObjectURL(image): user?.image || 
                    "https://www.google.com/url?sa=i&url=https%3A%2F%2Fgratisography.com%2Fphoto%2Fperson-wall-concept%2F&psig=AOvVaw25Z_lMsSnEBoXBB-z2AqKu&ust=1757332559024000&source=images&cd=vfe&opi=89978449&ved=0CBUQjRxqFwoTCPjMxI7Mxo8DFQAAAAAdAAAAABAE"}
        ...
        {image &&(
            ...
            text-primary cursor-pointer'>Save <img src={assets.check_icon} width={13} alt="" onClick={updateImage}/>
            </button>
        )}
        ...
        <div className='w-full'>
            ...
            {ownerMenuLinks.map((link,index)=>(
                ...
                ${link.path === location.pathname ? 'bg-primary/10 text-primary': 'text-gray-600'}`}>
                    ...
                    w-1 h-8 rounded-l right-0 absolute`}></div>
                </NavLink>
            ))}
        </div>
